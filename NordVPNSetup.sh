	...
	do
		...
		case $yn in
			[Yy]* )
				...
				echo " "
				LINKUDP="https://downloads.nordcdn.com/configs/files/ovpn_udp/servers/$1.nordvpn.com.udp.ovpn"
				LINKTCP="https://downloads.nordcdn.com/configs/files/ovpn_tcp/servers/$1.nordvpn.com.tcp.ovpn"
